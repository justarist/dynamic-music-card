    ...
    try {
        ...
        <svg width="600" height="150" viewBox="0 0 600 150" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg x="160" y="55" width="${containerWidth}" height="50">
                ...
                <g>
                    <text x="0" y="32" font-family="sans-serif" font-size="36" font-weight="bold" fill="#fff">
                    ${escapedTitle}
                    </text>

                    ${titleLength > 19 ? `
                    <text x="${titleWidth}" y="32" font-family="sans-serif" font-size="36" font-weight="bold" fill="#fff">
                    ${escapedTitle}
                    </text>
